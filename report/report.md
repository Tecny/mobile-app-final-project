...
| :-: | :-: | :-: | :-: | :-: |
|US01|Registro de cuenta de usuario|Como jugador o propietario deseo registrarme para tener una cuenta en la aplicación web D'Taquito|<p>***Escenario 1: Registro de cuenta exitoso***</p><p></p><p>Dado que el jugador se encuentra en la pantalla de registro de cuenta</p><p>Cuando el jugador ingresa los datos de su registro de cuenta completos y correctos en los campos: nombre, correo electrónico, contraseña y rol</p><p>Y hace clic en el botón “Registrarse”</p><p>Entonces la aplicación crea la cuenta para el jugador</p><p>Y la aplicación web redirecciona al usuario al login</p><p></p><p>***Escenario 2: Registro de cuenta fallido por insertar datos incorrectos***</p><p></p><p>Dado que el jugador se encuentra en la pantalla de registro de cuenta</p><p>Cuando el jugador ingresa los datos de su registro de cuenta incompletos e/o incorrectos en los campos: nombre, correo electrónico, contraseña y rol</p><p>Y hace clic en el botón “Registrarse”</p><p>Entonces la aplicación web muestra error en los datos ingresados erróneamente o faltantes</p><p></p><p>***Escenario 3: Registro de cuenta fallido por un correo ya registrado***</p><p></p><p>Dado que el propietario se encuentra en la pantalla de registro de cuenta</p><p>Cuando el propietario ingresa los datos de su registro de cuenta completos y correctos en los campos: nombre, correo electrónico, contraseña y rol</p><p>Y selecciona un plan des suscripción de su gusto</p><p>Y registra un método de pago válido y con saldo suficiente</p><p>Y hace clic en el botón “Registrarse”</p><p>Entonces la aplicación crea la cuenta para el propietario</p><p>Y la aplicación web redirecciona al propietario al login</p><p></p><p>***Escenario 4: Registro de cuenta fallido de propietario***</p><p></p><p>Dado que el propietario se encuentra en la pantalla de registro de cuenta</p><p>Cuando el propietario ingresa los datos de su registro de cuenta incompletos e/o incorrectos en los campos: nombre, correo electrónico, contraseña y rol</p><p>Y no selecciona un plan de suscripción de su gusto</p><p>Y no registra un método de pago válido y con saldo suficiente</p><p>Y hace clic en el botón “Registrarse”</p><p>Entonces la aplicación web muestra errores en los datos ingresados erróneamente o faltantes, o en la parte fallida del proceso</p><p></p><p>***Escenario 5: Registro de cuenta fallido por un correo ya registrado***</p><p></p><p>Dado que el jugador o propietario se encuentra en la pantalla de registro de cuenta</p><p>Cuando el jugador o propietario ingresa los datos de su registro de cuenta completos y correctos en los campos: nombre, correo electrónico, contraseña y rol</p><p>Y hace clic en el botón “Registrarse”</p><p>Entonces la aplicación web muestra un mensaje de error indicando que ya existe un correo en uso</p>|EP01|
...
|US03|Ver perfil de usuario|Como jugador o propietario quiero acceder a mi perfil para visualizar mis datos personales|<p><b>***Escenario 1: Acceso a perfil***</b></p><p></p><p>Dado que el jugador o propietario se encuentra logueado y en la página principal</p><p>Y el jugador o propietario da clic en el botón "Mi cuenta" en la parte del encabezado</p><p>Y da clic en "Mi perfil"</p><p>Entonces, la aplicación muestra la información de perfil del jugador o propietario</p>|EP01|
|US04|Editar perfil de usuario|Como usuario jugador o propietario deseo acceder a mi perfil para editar mis datos personales|<p><b>***Escenario 1: Edición de información correcta***</b></p><p></p><p>Dado que el usuario está dentro de la sección “Mi Perfil”</p><p>Y da clic en el botón "Editar perfil"</p><p>Cuando el usuario edita correctamente su información completa</p><p>Y da clic en el botón “Confirmar”</p><p>Entonces la aplicación web actualiza la información del usuario.</p><p></p><p><b>***Escenario 2: Edición de información incorrecta***</b></p><p></p><p>Dado que el usuario está dentro de la sección “Mi Perfil”</p><p>Y da clic en el botón "Editar perfil"</p><p>Cuando el usuario edita incorrectamente su información completa</p><p>Y da clic en el botón “Confirmar”</p><p>Entonces la aplicación muestra un error al editar.</p>|EP01|
|US05|Agregar una tarjeta como método de pago|Como jugador o propietario quiero agregar un método de pago para pagar los recursos de la aplicación|<p><b>***Escenario 1: Éxito al agregar método de pago***</b></p><p></p><p>Dado que el jugador o propietario está en la página de información de pago</p><p>Y no tiene un método de pago guardado</p><p>Y da clic en “Agregar método de pago”</p><p>Cuando el jugador o propietario registra su método de pago preferido de forma correcta</p><p>Y da clic en “Guardar”</p><p>Entonces la aplicación web agrega la información de pago del usuario jugador o propietario.</p><p></p><p><b>***Escenario 2: Fallo al agregar método de pago***</b></p><p></p><p>Dado que el jugador o propietario está en la página de información de pago</p><p>Y no tiene un método de pago guardado</p><p>Y da clic en “Agregar método de pago”</p><p>Cuando el jugador o propietario registra su método de pago preferido de forma incorrecta</p><p>Y da clic en “Guardar”</p><p>Entonces la aplicación web muestra un error en la información del método de pago.</p>|EP02|
|US06|Visualizar Método de pago|Como jugador o propietario quiero visualizar mi método de pago registrado para gestionarla|<p><b>***Escenario 1: Ver información de método de pago***</b></p><p></p><p>Dado que el jugador o propietario está en la página principal</p><p>Y ha iniciado sesión</p><p>Cuando el usuario jugador da clic al botón "Mi cuenta"</p><p>Y selecciona la opción “Billetera”</p><p>Entonces la aplicación web muestra la información de método de pago del jugador o propietario</p>|EP02|
|US07|Borrar un método de pago|Como usuario jugador o propietario quiero borrar mi método de pago existente para que ya no esté disponible|<p><b>***Escenario 1: Borrar método de pago***</b></p><p></p><p>Dado que el jugador o propietario está en la página de información de pago</p><p>Cuando el jugador o propietario seleccione su método de pago existente</p><p>Y da clic en “Borrar”</p><p>Entonces la aplicación web elimina el método de pago del jugador o propietario</p>|EP02|
|US08|Visualizar salas de juego|Como jugador quiero visualizar las salas de juego disponibles para buscar entre las opciones de mi preferencia|<p><b>***Escenario 1: Buscar por lista***</b></p><p></p><p>Dado que el jugador está en la página principal</p><p>Y ha iniciado sesión</p><p>Y va al apartado de “Salas de juego”</p><p>Cuando de clic en el deporte de su gusto (fútbol o billar)</p><p>Entonces la aplicación web mostrará una lista de salas del deporte escogido</p>|EP03|
|US09|Crear una sala de juego|Como jugador quiero crear una sala de juego para empezar la búsqueda de personas dispuestas a jugar un partido|<p><b>***Escenario 1: Creación exitosa de sala de juego***</b></p><p></p><p>Dado que el jugador está en la página principal</p><p>Y ha iniciado sesión</p><p>Y va al apartado de “Salas de juego”</p><p>Y de clic en el deporte de su gusto (fútbol o billar)</p><p>Cuando de clic al botón “crear sala de juego” arriba a la derecha</p><p>Y el jugador llene correctamente los parámetros: Título, fecha, hora, cantidad de jugadores y descripción.</p><p>Y de clic en “Crear sala”</p><p>Entonces la aplicación creará la sala y se visualizará en la web.</p><p></p><p><b>***Escenario 2: Creación de sala de juego fallida por título largo***</b></p><p></p><p>Dado que el jugador está en la página principal</p><p>Y ha iniciado sesión</p><p>Y va al apartado de “Salas de juego”</p><p>Y de clic en el deporte de su gusto (fútbol o billar)</p><p>Cuando de clic al botón “crear sala de juego” arriba a la derecha.</p><p>Y el jugador llene correctamente los parámetros: Fecha, hora, cantidad de jugadores y descripción, pero el título exceda la cantidad de caracteres permitidos</p><p>Y de clic en “Crear sala”</p><p>Entonces la aplicación web no permitirá crear la sala y exigirá reducir la cantidad de caracteres.</p>|EP03|
|US10|Borrar una sala de juego|Como jugador administrador quiero borrar una sala de juego para cancelar la búsqueda de jugadores|<p><b>***Escenario 1: Éxito al borrar sala de juego***</b></p><p></p><p>Dado que el jugador se encuentra en una sala de juego que él ha creado</p><p>Cuando haga clic en el botón “borrar sala”</p><p>Y confirme la acción mediante un cuadro de diálogo.</p><p>Entonces la aplicación web borrará la sala</p><p>Y no se podrá visualizar en la lista de salas.</p>|EP03|
|US11|Editar una sala de juego|Como jugador quiero editar los parámetros de la sala para actualizar los detalles.|<p><b>***Escenario 1: Edición exitosa de la sala de juego***</b></p><p></p><p>Dado que el jugador creador de la sala se encuentra en la pantalla de edición de sala</p><p>Cuando el administrador modifica la descripción</p><p>Entonces los cambios se guardan y son visibles para todos los usuarios</p><p>Y el administrador recibe una confirmación de que los cambios han sido guardados.</p>|EP03|
|US12|Ingresar a una sala de juego|Como jugador quiero ingresar a una sala de juego de mi preferencia para participar en una partida de billar o fútbol|<p><b>***Escenario 1: Ingreso exitoso a la sala de juego***</b></p><p></p><p>Dado que el jugador ya ha escogido su deporte de preferencia</p><p>Y haya ingresado a la sala de su preferencia</p><p>Cuando el jugador selecciona el botón “Unirse”</p><p>Y seleccione un método de pago agregado con saldo suficiente para pagar la cuota de entrada</p><p>Y da clic en el botón “Aceptar”</p><p>Entonces el jugador ingresará a participar en la sala.</p><p></p><p><b>***Escenario 2: Ingreso fallido a la sala de juego***</b></p><p></p><p>Dado que el jugador ya ha escogido su deporte de preferencia</p><p>Y haya ingresado a la sala de su preferencia</p><p>Cuando el jugador selecciona el botón “Unirse”</p><p>Y seleccione un método de pago agregado con saldo insuficiente para pagar la cuota de entrada</p><p>Y da clic en el botón “Aceptar”</p><p>Entonces el jugador no ingresará a participar en la sala.</p><p>Y la aplicación le mostrará el error del método de pago.</p>|EP03|
|US13|Aplicar filtros de búsqueda|Como jugador quiero aplicar filtros para encontrar salas de juego según mis preferencias de forma rápida|<p><b>***Escenario 1: Filtrar salas de juego***</b></p><p></p><p>Dado que el jugador se encuentra en la página de visualización de las salas de juego de su deporte preferido</p><p>Cuando el jugador da clic en la barra de filtro</p><p>Y escribe un texto clave</p><p>Entonces la aplicación web muestra las salas de juego que coincidan con el texto clave.</p>|EP03|
|US14|Ver el chat de la sala de juego|Como jugador quiero ver el chat de la sala de juego para saber lo que comentan otros jugadores|<p><b>***Escenario 1: Visualizar el chat de la sala de juego***</b></p><p></p><p>Dado que el jugador se encuentra en la página de visualización de las salas de juego de su deporte preferido</p><p>Cuando el jugador da clic en una sala de juego en la que ya se unió</p><p>Entonces la aplicación web muestra todos los detalles de la sala, donde se incluye el chat en la parte inferior derecha.</p>|EP03|
|US15|Usar el chat de la sala de juego|Como jugador quiero usar el chat de la sala de juego para comunicar mis opiniones o mensajes con los demás jugadores|<p><b>***Escenario 1: Usar el chat de la sala de juego***</b></p><p></p><p>Dado que el jugador se encuentra dentro de una sala de juego en la que se unió</p><p>Cuando el jugador escribe un mensaje en la barra de escritura</p><p>Y da clic en el botón “Enviar”</p><p>Entonces la aplicación web envía y muestra el mensaje en el chat.</p>|EP03|
|US16|Visualizar equipos dentro de una sala de juego|Como jugador de fútbol quiero ver los equipos de la sala de juego para saber cómo se han organizado|<p><b>***Escenario 1: Visualizar equipos de la sala de juego***</b></p><p></p><p>Dado que el jugador se encuentra en la página de visualización de las salas de juego de su deporte preferido</p><p>Cuando el jugador da clic en una sala de juego en la que ya se unió</p><p>Entonces la aplicación web muestra todos los detalles de la sala, donde se incluyen los equipos en la parte superior derecha.</p>|EP03|
|US17|Unirse a un equipo dentro de una sala de juego|Como jugador de fútbol quiero unirme a un equipo de la sala de juego para escoger un bando|<p><b>***Escenario 1: Unirse a un equipo de la sala de juego***</b></p><p></p><p>Dado que el jugador se encuentra dentro de una sala de juego en la que se unió</p><p>Y haya disponibilidad de espacio en el equipo deseado</p><p>Cuando el jugador da clic en el botón “+” del equipo deseado</p><p>Entonces la aplicación web colocará su nombre debajo del equipo seleccionado.</p>|EP03|
|US18|Cambiarme de equipo dentro de una sala de juego|Como jugador de fútbol quiero cambiarme de equipo en una sala de juego para jugar para el equipo de mi preferencia|<p><b>***Escenario 1: Cambio de equipo exitoso***</b></p><p></p><p>Dado que el jugador se encuentra dentro de una sala de juego en la que se unió</p><p>Y haya disponibilidad de espacio en el equipo deseado</p><p>Cuando el jugador da clic en el botón “+” del equipo contrario</p><p>Entonces la aplicación web cambiará su nombre debajo del equipo contrario.</p>|EP03|
|US19|Ver una suscripción|Como propietario quiero ver el estado de mi suscripción para gestionarla|<p><b>***Escenario 1: Visualizar suscripción***</b></p><p></p><p>Dado que el propietario se encuentra en la página principal</p><p>Cuando el propietario da clic en su ícono en la esquina superior de la aplicación web y clic en el botón "Mi cuenta"</p><p>Y da clic en la sección “Suscripción”</p><p>Entonces la aplicación web visualiza la suscripción actual del propietario.</p>|EP04|
|US20|Adquirir una suscripción|Como usuario propietario quiero adquirir una suscripción para usar los beneficios que me da|<p><b>***Escenario 1: Éxito al adquirir la suscripción***</b></p><p></p><p>Dado que el propietario se encuentra en la página de suscripción</p><p>Y tiene una suscripción gratuita</p><p>Cuando el propietario da clic en “Actualizar mi suscripción” de la suscripción de su preferencia</p><p>Y el propietario tiene un método de pago con saldo suficiente</p><p>Entonces la aplicación web registra la suscripción del propietario</p><p>Y el propietario obtiene la membresía del rango adquirido.</p><p></p><p><b>***Escenario 2: Error al adquirir la suscripción***</b></p><p></p><p>Dado que el propietario se encuentra en la página de suscripción</p><p>Y tiene una suscripción gratuita</p><p>Cuando el propietario da clic en “Actualizar mi premium” de la suscripción de su preferencia</p><p>Y el propietario no tiene un método de pago registrado o no tiene saldo suficiente</p><p>Entonces la aplicación web no registra la suscripción del propietario</p><p>Y muestra un error en el pago.</p>|EP04|
|US21|Cancelar una suscripción|Como propietario quiero cancelar una suscripción para dejar de usar los beneficios|<p><b>***Escenario 1: Éxito al cancelar la suscripción***</b></p><p></p><p>Dado que el propietario se encuentra en la página de suscripción</p><p>Y tiene una suscripción premium</p><p>Cuando el usuario propietario da clic en “Cancelar suscripción”</p><p>Y da clic en el botón “Confirmar”</p><p>Entonces la aplicación web cancela el plan del propietario</p><p>Y el propietario pasa a tener una suscripción gratuita.</p>|EP04|
|US22|Actualizar una suscripción|Como usuario propietario quiero actualizar mi suscripción para usar los beneficios que me da|<p><b>***Escenario 1: Éxito al actualizar la suscripción***</b></p><p></p><p>Dado que el propietario se encuentra en la página de suscripción</p><p>Y tiene una suscripción premium</p><p>Cuando el propietario da clic en “Actualizar mi suscripción” de la suscripción de su preferencia</p><p>Y el propietario tiene un método de pago con saldo suficiente</p><p>Entonces la aplicación web actualiza la suscripción del propietario</p><p>Y el propietario obtiene la membresía del rango adquirido.</p><p></p><p><b>***Escenario 2: Error al actualizar la suscripción***</b></p><p></p><p>Dado que el propietario se encuentra en la página de suscripción</p><p>Y tiene una suscripción gratuita</p><p>Cuando el propietario da clic en “Actualizar a premium” de la suscripción de su preferencia</p><p>Y el propietario no tiene un método de pago registrado o no tiene saldo suficiente</p><p>Entonces la aplicación web no actualiza la suscripción del propietario</p><p>Y muestra un error en el pago.</p>|EP04|
|US23|Visualizar espacios deportivos|Como jugador o propietario quiero ver los espacios deportivos que existen en la aplicación para conocerlos|<p><b>***Escenario 1: Visualizar espacios deportivos en la página principal siendo jugador***</b></p><p></p><p>Dado que el jugador se encuentra en la página principal</p><p>Cuando el jugador da clic en el apartado "Espacios de juego"</p><p>Entonces la aplicación web muestra todos los espacios deportivos.</p><p></p><p><b>***Escenario 2: Visualizar espacios deportivos dentro de una sala de juego siendo jugador***</b></p><p></p><p>Dado que el jugador se encuentra en la página de salas</p><p>Cuando el jugador da clic en una sala en la que pertenece</p><p>Entonces la aplicación web muestra en la sala los espacios deportivos recomendados según la ubicación preferida de la sala.</p><p></p><p><b>***Escenario 3: Visualizar espacios deportivos siendo propietario***</b></p><p></p><p>Dado que el propietario se encuentra en la página principal</p><p>Cuando el propietario da clic en el apartado "Espacios de juego"</p><p>Entonces la aplicación web muestra sus espacios deportivos registrados.</p>|EP05|
|US24|Añadir un espacio deportivo|Como propietario de un espacio deportivo quiero añadir mi local a la aplicación web para que los jugadores puedan visualizar mi local|<p><b>***Escenario 1: Éxito al añadir un espacio deportivo***</b></p><p></p><p>Dado que el propietario de un espacio deportivo se encuentra en la sección de visualización de sus espacios deportivos</p><p>Cuando el propietario da clic en “Añadir espacio deportivo”</p><p>Y registra correctamente todos los datos solicitados</p><p>Y da clic en “Confirmar”</p><p>Entonces la aplicación web añade el espacio de juego en la plataforma.</p><p></p><p><b>***Escenario 2: Error al añadir un espacio deportivo***</b></p><p></p><p>Dado que el propietario de un espacio deportivo se encuentra en la sección de visualización de sus espacios deportivos</p><p>Cuando el propietario da clic en “Añadir espacio deportivo”</p><p>Y registra incorrectamente todos los datos solicitados</p><p>Y da clic en “Confirmar”</p><p>Entonces la aplicación web mostrará un error en los datos ingresados</p><p>Y le pide al propietario corregir los errores necesarios.</p>|EP05|
|US25|Editar un espacio deportivo|Como propietario de un espacio deportivo quiero editar mi local en la aplicación web para modificar información del espacio deportivo|<p><b>***Escenario 1: Éxito al editar un espacio deportivo***</b></p><p></p><p>Dado que el propietario de un espacio deportivo se encuentra en la sección de visualización de sus espacios deportivos</p><p>Cuando el propietario da clic en “Editar espacio de juego” seleccionado</p><p>Y registra correctamente todos los datos solicitados</p><p>Y da clic en “Confirmar”</p><p>Entonces la aplicación web edita el espacio de juego en la plataforma.</p><p></p><p><b>***Escenario 2: Error al editar un espacio deportivo***</b></p><p></p><p>Dado que el propietario de un espacio deportivo se encuentra en la sección de visualización de sus espacios deportivos</p><p>Cuando el propietario da clic en “Editar espacio de juego”</p><p>Y registra incorrectamente todos los datos solicitados</p><p>Y da clic en “Confirmar”</p><p>Entonces la aplicación web mostrará un error en los datos ingresados</p><p>Y le pide al propietario corregir los errores necesarios.</p>|EP05|
|US26|Eliminar un espacio deportivo|Como propietario de un espacio deportivo quiero eliminar mi local en la aplicación web para que no se visualice más|<p><b>***Escenario 1: Borrar un espacio deportivo***</b></p><p></p><p>Dado que el propietario de un espacio deportivo se encuentra en la sección de visualización de sus espacios deportivos</p><p>Cuando el propietario da clic en “Borrar espacio de juego”</p><p>Y da clic en “Confirmar”</p><p>Entonces la aplicación web borra el espacio de juego en la plataforma.</p>|EP05|
|US27|Conocer acerca de la aplicación web|Como visitante de la landing page quiero saber acerca de la aplicación web para conocer sus detalles|<p><b>***Escenario 1: Leer acerca de la aplicación web mediante hipervínculo***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante da clic a “Acerca de”</p><p>Entonces la landing page lo dirige a la sección de conocimiento.</p><p></p><p><b>***Escenario 2: Leer acerca de la aplicación web haciendo scroll***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante se moviliza hasta la sección “Acerca de”</p><p>Entonces el visitante podrá leer sobre el conocimiento de la aplicación web.</p>|EP06|
|US28|Conocer los planes de la aplicación web|Como visitante de la landing page quiero conocer los planes que ofrecen para conocer sus detalles|<p><b>***Escenario 1: Leer planes de la aplicación web mediante hipervínculo***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante da clic a “Planes”</p><p>Entonces la landing page lo dirige a la sección de planes.</p><p></p><p><b>***Escenario 2: Leer planes de la aplicación web haciendo scroll***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante se moviliza hasta la sección “Planes”</p><p>Entonces el visitante podrá leer sobre los planes de la aplicación web.</p>|EP06|
|US29|Ver información de los desarrolladores|Como visitante de la landing page quiero ver la información de los desarrolladores para conocer sus perfiles|<p><b>***Escenario 1: Leer sobre los desarrolladores de la aplicación web mediante hipervínculo***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante da clic a “Nosotros”</p><p>Entonces la landing page lo dirige a la sección de la información de los desarrolladores.</p><p></p><p><b>***Escenario 2: Leer sobre los desarrolladores de la aplicación web haciendo scroll***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante se moviliza hasta la sección “Nosotros”</p><p>Entonces el visitante podrá leer la información sobre los desarrolladores.</p>|EP06|
|US30|Leer preguntas frecuentes|Como visitante de la landing page quiero leer preguntas frecuentes para conocer dudas comunes de la aplicación web|<p><b>***Escenario 1: Leer preguntas frecuentes de la aplicación web mediante hipervínculo***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante da clic a “Preguntas”</p><p>Entonces la landing page lo dirige a la sección de preguntas frecuentes.</p><p></p><p><b>***Escenario 2: Leer preguntas frecuentes de la aplicación web haciendo scroll***</b></p><p></p><p>Dado que el visitante se encuentra en el landing page</p><p>Cuando el visitante se moviliza hasta la sección “Preguntas frecuentes”</p><p>Entonces el visitante podrá leer sobre las preguntas frecuentes de la aplicación web.</p>|EP06|
